...
struct e1000_rx_desc rxdesc_list[NUM_RX_DESC]; // Receive Descriptor Ring
...
e1000_rx_init()
{
    ...
    e1000_write(E1000_RA, 0x52540012); // RAL[0]
    e1000_write(E1000_RA + 4, E1000_RAH_AV | 0x3456); // RAH[0]
    ...
    rctl_reg = SET_RCTL_EN(1)|SET_RCTL_LPE(1)|E1000_RCTL_LBM_NO|E1000_RCTL_RDMTS_HALF 
                 |SET_RCTL_BAM(1)|E1000_RCTL_SZ_1024|SET_RCTL_BSEX(0)|SET_RCTL_SECRC(1);
